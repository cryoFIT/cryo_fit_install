...
typedef struct {
  ...
  int  emsteps;         /* MDfit- frequency for calculating EM map potential      */
  real emweight;        /* MDfit- EM map strength               */
  real emsigma;         /* MDfit- resolution/standard deviation of Gaussian kernel */
  real emcutoff;        /* MDfit acceptance error for cutoff              */
  real emthresh;        /* MDfit density cutoff            */
  int  emwritefrequency;         /* MDfit- frequency to write out theoretical maps  */
