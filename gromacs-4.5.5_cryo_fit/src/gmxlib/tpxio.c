                        ...
                        int file_version, real *fudgeQQ)
{
	...
	/* MDfit stuff*/
    gmx_fio_do_int(fio,ir->emsteps);
    gmx_fio_do_real(fio,ir->emweight);
    gmx_fio_do_int(fio,ir->emwritefrequency);
    gmx_fio_do_real(fio,ir->emthresh);
    gmx_fio_do_real(fio,ir->emsigma);
    gmx_fio_do_real(fio,ir->emcutoff);
    gmx_fio_do_int(fio,ir->opts.ngmdfit);
